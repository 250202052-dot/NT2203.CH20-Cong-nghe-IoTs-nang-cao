...
function updateTemperature() {
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      let x = Date.now();                 // ✅ timestamp UTC
      let y = parseFloat(this.responseText);

      document.getElementById('temperature-output').textContent = y.toFixed(1);
...
function updateHumidity() {
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById('humidity-output').textContent = y.toFixed(1);

      chartH.series[0].addPoint([x, y], true,
...
function updatePressure() {
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById('pressure-output').textContent = y.toFixed(1);

      chartP.series[0].addPoint([x, y], true,
        chartP.series[0].data.length > 40);
    }
  };
...
function updatePredict() {
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById('Predict').textContent = this.responseText;
    }
  };
